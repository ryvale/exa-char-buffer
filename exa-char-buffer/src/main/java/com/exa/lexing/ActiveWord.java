...
public class ActiveWord {
	...
	public CharProperty<Boolean> nextUntilEnd(CharReader script, StringBuilder bufferContent) throws ParsingException { return new CharProperty<>(null, Boolean.FALSE);}
}
